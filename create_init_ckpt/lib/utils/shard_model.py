...
def convert_args(args, kwargs, device, dtype):
    ...
    def convert_tensor(tensor):
        if tensor.dtype == torch.float16 or tensor.dtype == torch.float32 or tensor.dtype == torch.bfloat16:
...
class ShardTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        from ..linear.fused_quantized_linear import FusedQuantizedLinear
        ...
        self.dtype = torch.float32 if to_float else torch.bfloat16
